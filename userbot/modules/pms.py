...
DEF_UNAPPROVED_MSG = (
    ...
    f"   `{DEFAULTUSER}`\n"
    "Saya Adalah Bot Yang Menjaga Room Chat Bos `{DEFAULTUSER}`. Mohon Jangan Melakukan Spam Ke Room Chat Bos Karna Jika Anda Melakukan Itu Saya Akan Otomatis Memblokir Anda, Tunggulah Sampai Bos `{DEFAULTUSER}` Menerima Pesan Anda, Terimakasih ヅ
